...
<head>
    ...
    <title>Daftar - E-Book Store</title>
...
<body class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <p class="text-gray-600 text-center mt-2">Daftar dan mulai membaca</p>
            ...
            <p class="mt-6 text-center text-gray-600">
                Sudah punya akun? 
                <a href="{{ route('login') }}" class="text-primary-600 font-medium hover:text-primary-700">Masuk di sini</a>
            </p>
        </div>
