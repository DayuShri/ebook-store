...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="#"
                    class="p-4 border border-gray-200 rounded-lg text-center hover:border-primary-500 hover:bg-primary-50 transition-colors">
                    <svg class="w-8 h-8 mx-auto text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="#"
                    ...
                    <span class="block mt-2 text-sm font-medium">Laporan</span>
                </a>
            </div>
        </div>

        <p class="text-center text-gray-500 mt-8 text-sm">
            <em>Ini adalah halaman placeholder untuk admin dashboard. Fitur lengkap akan dikembangkan kemudian.</em>
        </p>
    </div>
@endsection